...
<script>
  ...
  function multi_bill_upload(){
    //alert("hello 1");
    document.getElementById('bill_report').action='process_multiple_bill_imgfile_name_upload.php';
  ...
  function bill_search_submit(){
    //alert("hello");
    document.getElementById('bill_report').action='upload_multiple_bill_imgfile_name.php';
		document.getElementById('bill_report').submit();
...
<!--
              ...
              <?php include("upload_multiple_bill_imgfile_name_display.php"); ?>   
              <?php }  } ?>           
            </div>                                 
          </td>
        </tr>
